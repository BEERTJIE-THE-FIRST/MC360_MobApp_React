        ...
        <ImageBackground style={styles.container} source={require("../../../assets/backgroundmicash.png")}>
            <View style={styles.content}>
                <Text style={styles.infoText}>
                    To protect all MiCash360 users and to comply with FICA regulations, your identity details will be
                    independently verified
                </Text>
                <Text style={styles.label}>Identification Document</Text>
                <View style={styles.radioContainer}>
                    <RadioButtonInput status={selectedDocType === "saID" ? "checked" : "unchecked"} value={"saID"} onPress={() => handleDocTypeChange("saID")} label={"South African"} radio_color={"#007BFF"} color={"#354A87"}/>
                    
                    <RadioButtonInput status={selectedDocType === "passport" ? "checked" : "unchecked"} value={"passport"} onPress={() => handleDocTypeChange("passport")} label={"Passport"} radio_color={"#007BFF"} color={"#354A87"}/>
                ...
                /> */}
                <AuthenticationTextInput placeholder={"Required*"} value={""} onChangeText={handleInputChange} keyboardType={selectedDocType === "saID" ? "numeric" : "default"}/>

                {/* <TouchableOpacity style={styles.button} onPress={handleContinue}>
                    <Text style={styles.buttonText}>Continue</Text>
                </TouchableOpacity> */}

                <Button onPress={handleContinue} name={"Continue"} color={undefined} disabled={false} />
