    ...
    >
      ...
      <View style={styles.textContent}>
        ...
        <Text style={styles.description}>
          Receive mobile payments from any South African bank's Masterpass
          application, Vodapay, Nedbank Money, FNB scan-to Pay or other MiCash
          users
        </Text>
      </View>
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity onPress={() => AuthBtn_Clicked()}>
          <Image
            ...
            style={[
              { width: 365, height: 55, resizeMode: "contain" },
              styles.button,
            ]}
          />
        </TouchableOpacity>
        ...
        <View style={styles.forgotDetailsAndRegister}>
          <TouchableOpacity onPress={() => ForgotDetails_Clicked()}>
            <Text style={styles.forgotDetailsAndRegister_text}>
              Forgot Details
            </Text>
          </TouchableOpacity>
