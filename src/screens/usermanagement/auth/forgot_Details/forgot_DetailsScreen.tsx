  ...
  return (
    ...
    >
      ...
      <Text style={styles.subtitle}>
        Please supply a mobile number or email address to receive a reset code
      </Text>
      ...
      <TouchableOpacity onPress={() => submit_Clicked()} style={styles.button}>
      ...
      >
        <Text style={styles.button_text_back}>Back to home</Text>
      </TouchableOpacity>
